...
Canonical definition revised: 2026-01-31  
Page formatting updated: 2026-07-11
...
2026年1月31日改訂版｜森内 孝  
課題解決型民主主義 公式定義（Canonical Definition）｜Problem-Solving Democracy

### 1. 公式定義（仕様としての定義）

課題解決型民主主義（Problem-Solving Democracy、以下「PSD」）とは、国民主権と代表制を前提に、社会課題をスローガンではなく因果構造（原因→結果の連鎖）として捉え、その構造・仮説・進捗・結果を、国益や公共性に配慮した適切な情報公開の原則のもとで国民と継続的に共有しながら、政党・議会・行政・専門家・地域・市民が、役割分担のもとで「競争」と「協働」を同時に回し続けることにより、政策を改善しながら成果を出す統治モデルである。
...
なお、本概念は、既存の民主主義制度や政策決定プロセスを置き換えるものではない。現在すでに行われている政策立案・実行・評価の各段階を、因果構造の共有と検証可能性という視点から整理し直すことで、同じ制度のまま政策の実効性が高まる可能性を広げることを目的としている。

PSDは、狭義には民主主義の運用様式（オペレーションモード）を指す。
...
PSDにおいて政策は固定的決定ではなく、実行→検証→修正を前提とした「仮説」である。
...
国民主権のもとでは主権者は国民であり、最終的な意思決定は選挙で行われる。したがって、国民が適切に選択するためには、課題の構造と政策効果が共有されている必要がある。

PSDでは、選挙において国民が

- 「どの課題の、どの要因に手を打ったか」
- 「結果として何が改善したか」
- 「仮説が外れたときにどう修正したか（学びの質）」
...
中長期・普遍課題は一度の政権交代で完結しないため、協働なしでは継続的成果が出にくい。一方、競争がなければ選択肢が失われ、主権者の判断材料が劣化する。よって、競争と協働は同時に必要であり、両立こそが制度設計の核心となる。
...
北欧やオランダ等の事例は参考になりうるが、本概念は特定国モデルのコピーではない。

企業経営やプロジェクトマネジメントで用いられてきた構造化・KPI・PDCA/OODAといった技法を、国民主権と代表制民主主義の枠組みの中で運用可能な形に再設計する試みである。

#### 「教育PBL」や「市民参加DX」「AI活用民主主義」の一般論でもない

教育現場でのPBLや、市民参加型DX、AIやデジタル技術の活用は、課題解決型民主主義においても有効な手段になりうる。本概念は、これらの技術や仕組みの活用を否定するものではない。

しかし、PSDの中核は、AIやデジタル技術そのものにあるのではなく、それらを用いてもなお、国民が課題の構造と政策の因果関係を理解し、納得と実効性を伴った選択を行える状態を実現することにある。

すなわち、AIは意思決定を代替する存在ではなく、国民主権のもとで、判断に必要な構造・仮説・結果を可視化する補助線として位置づけられる。

PSDは、国家レベルの政策運用において、評価・改善・継続・選挙による選択までを含め、国民が主体として判断できる状態を制度として実現することを中核に据えた統治の設計思想である。
...
PSDにおける「不完全さ」とは制度の欠陥を意味するものではなく、仮説と検証を通じて継続的に改善されることを前提とした学習型統治システムである点に本質がある。
...
- Latest page (2026-07-11): Markdown structure and typography refined; obvious wording error corrected. No change to the intended canonical meaning.
